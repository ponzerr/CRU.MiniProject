        ...
        <div class="mt-12 mb-8 flex flex-col gap-12">
            <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-800 shadow-md">
                <div class="relative bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-emerald-600 to-green-600 text-white shadow-gray-900/20 shadow-lg -mt-6 mb-8 p-6">
                    <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">Edit Item</h6>
                </div>
                            ...
                            <div class="grid grid-cols-2 gap-y-4 gap-x-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="item_code" id="item_code" placeholder="Enter item code"
                                        class="mt-1 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md capitalize" oninput="this.value = this.value.toUpperCase();" value="{{ $item->item_code }}">
                                </div>
                                <!-- Item Description -->
                                <div>
                                    <label for="item_desc" class="block text-sm font-medium text-gray-700">Item Description</label>
                                    <input type="text" name="item_desc" id="item_desc" placeholder="Enter item description"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ $item->item_desc }}">
                                </div>
                                <!-- Price -->
                                <div>
                                    <label for="item_price" class="block text-sm font-medium text-gray-700">Price</label>
                                    <input type="text" name="item_price" id="item_price" placeholder="Enter price"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ $item->item_price }}">
                                </div>
                                <!-- Item Group Dropdown -->
                                <div>
