 ...
 <div class="mt-12 mb-8 flex flex-col gap-12">
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
        <div class="relative bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-emerald-600 to-green-600 text-white shadow-gray-900/20 shadow-lg -mt-6 mb-8 p-6">
            ...
            <a href="" class="absolute top-1/2 right-4 transform -translate-y-1/2 bg-transparent border-none focus:outline-none transition-all select-none font-sans font-medium text-center uppercase w-8 max-w-[32px] h-8 max-h-[32px] rounded-lg text-xs text-white hover:bg-white/10 active:bg-white/30">
